...
The action will also create a coverage file that can be digested by other actions, such as [step-security/lcov-reporter-action](https://github.com/step-security/lcov-reporter-action) that can comment PRs with the coverage report.
...
- name: Test coverage
  uses: step-security/spm-lcov-action@0
  with:
